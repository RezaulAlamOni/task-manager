        ...
        <div class="row">
            ...
            <div class="col-2">
                ...
                <a class="calender li-opacity clickHide" v-if="!selectedData.date">
                    <i class="outline-event icon-image-preview" title="toggle" data-toggle></i>
                </a>
                ...
                <ul>
                            ...
                            <i v-if="selectedData.tags.length > 0">
                                <template v-for="tag in selectedData.tags">
                                    <li class="badge-pill tags" v-if="tag.text !== null"
                ...
                <a class="user">
                    ...
                    <div class="dropdown-menu">
                                ...
                                <div class="row">
                                    <div class="col-md-3 pt-2 pl-5">
                                        <img src="data:image/jpeg;base64,"
                                             class="img-circle" style="width: 30px" alt="not found">
                                    </div>
                                    <div class="col-md-9">
                        ...
                        <li class="border-top pl-2">
                            ...
                            <switches v-model="id" style="position:absolute;right: 10px;bottom: -4px"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="textAreaExtend" v-click-outside="HideListDetails">
                            <div class="row">
                                <div class="col-12">
                                    <textarea class="form-control detailsInput" data-grow="auto" placeholder="Task Description"
                ...
                <div class="row">
                    <div class="col-12" v-if="selectedData.files && selectedData.files.length !== 0">
                        ...
                        <div style="cursor: pointer; background-color: #F8F8F8; margin:10px 0;">
                            <input type="file" :ref="selectedData._id" :id="'file'+selectedData._id" style="display: none;">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="textAreaExtend" v-click-outside="HideTextArea">
                            <textarea class="form-control commentInput" data-grow="auto" placeholder="Add comment" @focus="ShowTextArea(selectedData)"></textarea>
                            <div class="SubmitButton" id="SubmitButton">
                                ...
                                <a class="btn btn-default btn-sm" style="border: 1px solid #f1efe6" @click="addAttachment(selectedData)">
