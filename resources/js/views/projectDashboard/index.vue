                                    ...
                                    <a class="tag-icon hide-item-res">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" :id="'dropdown'+data._id">
                                            ...
                                            <diV class="collapse show switchToggle" style="">
                                                <li class="assignUser">
                                                    <input type="text" class="input-group searchUser" v-model="tag" @keypress="addTag($event,data)">
                                                    <label class="pl-2 pt-3">
                                                        <span class="badge badge-success" @click="addExistingTag($event,data,'Tags')">Tags</span>
                                                        <span class="badge badge-danger" @click="addExistingTag($event,data,'Dont Forget')">Dont Forget</span>
        ...
        data() {
            return {
                ...
                tree4data: [
                    ...
                    {id: 8, parent: 3, text: 'node 4', draggable: true, html: 'Test', date: '6 Aug', clicked: 0, tags: []},
                        ...
                        text: 'node 7', clicked: 0, date: '', children: [
                            ...
                            },
                            {
                                ...
                                text: 'node 7-3', children: [
                                    ...
                                    {id: 18, parent: 16, text: 'node 7-3-2 undroppable', droppable: false, clicked: 0, tags: []},
                                ], clicked: 0
                            },
