            ...
            <div class="col-4 text-center" >
                <a :class="{'tag-icon': true, 'tag-icon-free': selectedData.tags == undefined || selectedData.tags.length == 0}">
                    <div v-if="selectedData.tags && selectedData.tags.length !== 0" >
                        <div style="margin-top: -8px;" v-for="(item, tagIndex) in selectedData.tags">
                                        ...
                                        <a target="_blank" :href="'/storage/'+selectedData.cardId+'/'+files.file_name"
                                           style="cursor: pointer;position: absolute;">
                                            <div style="float: left;"
                                                 v-if="files.file_name.endsWith('.png') || files.file_name.endsWith('.jpg') || files.file_name.endsWith('.jpeg') || files.file_name.endsWith('.gif')">
                                            ...
                                            <div style="float: left;"
                                                 v-else-if="files.file_name.endsWith('.doc') || files.file_name.endsWith('.docx') || files.file_name.endsWith('.xls') || files.file_name.endsWith('.xlsx')">
                                                <img title="Click To Download" data-toggle="tooltip"
            ...
            <div aria-labelledby="comment-tab" class="tab-pane" id="comment" role="tabpanel" style="overflow: hidden;">
                <span>
                    <div class="row comment-section-in-task-details" style="max-height: calc(100vh - 285px);">
                        <div id='cmntSection'
                             style="margin:0px auto; max-height: calc(100vh - 350px); width: 90%; height: 1000px; margin-bottom: 20px; overflow: auto;">
                                                ...
                                                <span style="padding: 10px;"
                                                    ...
                                                    <a target="_blank"
                                                       ...
                                                       style="cursor: pointer;">
                                                        <div
                                                            v-if="comments.attatchment.endsWith('.png') || comments.attatchment.endsWith('.jpg') || comments.attatchment.endsWith('.gif')">
                                                            <img title="Click To Download" data-toggle="tooltip"
                                                        ...
                                                        <div
                                                            v-if="comments.attatchment.endsWith('.doc') || comments.attatchment.endsWith('.docx') || comments.attatchment.endsWith('.xls') || comments.attatchment.endsWith('.xlsx')">
                                                            <img title="Click To Download" data-toggle="tooltip"
                                                                 :src="'/img/file.png'" height="50" width="50">
                                                        </div>
                                                    </a>
