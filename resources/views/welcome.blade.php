    ...
    <div class="container">
        ...
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="#">
                <img class="logo-dark" src="../img/color-logo.png" alt="logo">
...
<main class="main-content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <p><img src="../img/vector/13.png" alt="..."></p>
                    <br>
    ...
    |‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
    !-->
    <section class="section py-10" style="background-image: url(../img/bg/4.jpg)">
        <div class="container">
            <div class="row">
    ...
    <div class="container">
        <div class="row gap-y">
            ...
            <div class="col-xl-4 order-md-first">
                ...
                <small class="opacity-70">© 2019 TheThemeio. All rights reserved.</small>
            </div>
